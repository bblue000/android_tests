 ...
 * 
 */
public class QuadToSurfaceView extends SurfaceView implements Callback, Runnable {
	 ...
	 * SurfaceView初始化函数
	 */
	public QuadToSurfaceView(Context context) {
		super(context);
		sfh = this.getHolder();
		...
		paintMiddle.setStyle(Style.FILL_AND_STROKE);

...
public class FinalBitmap
{
    ...
    {
        mConfig.defaultDisplayConfig.setLoadingBitmap(BitmapFactory.decodeStream(mContext
    ...
    {
        mConfig.defaultDisplayConfig.setLoadfailBitmap(BitmapFactory.decodeStream(mContext
                .getResources().openRawResource(resId)));
        return this;
    }
    ...
    public void display(ImageView imageView, String uri, Bitmap loadingBitmap, Bitmap laodfailBitmap)
    {
        ...
        if (displayConfig == null)
        {
            ...
            configMap.put(String.valueOf(loadingBitmap) + "_" + String.valueOf(laodfailBitmap),
                    displayConfig);
        }
            ...
            Bitmap loadingBitmap, Bitmap laodfailBitmap)
    {
        ...
        if (displayConfig == null)
        {
            ...
            displayConfig.setLoadingBitmap(loadingBitmap);
            displayConfig.setLoadfailBitmap(laodfailBitmap);
            configMap.put(imageWidth + "_" + imageHeight + "_" + String.valueOf(loadingBitmap)
                    + "_" + String.valueOf(laodfailBitmap), displayConfig);
        }
